...
const ModeLink = React.forwardRef<HTMLAnchorElement, LinkProps>(
  ({ children, className, ...props }, ref) => (
    <a
      {...props}
      ref={ref}
      className={`h-[30px] flex items-center gap-2 px-4 outline-none text-2 font-medium ring-1 ring-inset ring-transparent rounded-full
